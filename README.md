...
###DEMO: https://e-commerce-34a07.web.app/



###Deployed Link: https://e-commerce-34a07.web.app/
...
<details open="open">
  ...
  <ol>
    <li>
      ...
      <ul>
        <li><a href="#built-with">-Javascript ,React.js,Firebase,Context API,Stripe </a></li>
      </ul>
    </li>
...
* Add unlimited items to you cart, see the total 
* Beautiful UI to display relevant product info
* Easily look at each product
